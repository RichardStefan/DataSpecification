...
AF - FixIdentifier, TurnDirection, RecommandedNavaid, Theta (fix radial), RHO, MagCourse (boundary radial)
CA - MagCourse, Alt1+ (at or above)
CD - RecommandedNavaid, MagCourse RouteDISTANCEHoldingTime (DME distance)
CF - FixIdentifier, RecommandedNavaid, Theta, RHO, MagCourse (course to specific fix), RouteDISTANCEHoldingTime (Path length)
CI - MagCourse
CR - RecommandedNavaid, Theta, MagCourse
DF - FixIdentifier, FlyOver
FA - FixIdentifier, RecommandedNavaid, Theta, RHO, MagCourse, Alt1+ (at or above)
FC - FixIdentifier, FlyOver, RecommandedNavaid, Theta, RHO, MagCourse, RouteDISTANCEHoldingTime (Path length)
FD - FixIdentifier, RecommandedNavaid, Theta, RHO, MagCourse, RouteDISTANCEHoldingTime (DME distance)
FM - FixIdentifier, RecommandedNavaid, Theta, RHO, MagCourse
HA - FixIdnetifier, TurnDirection, MagCourse, RouteTIMEDistanceHoldingTime, Alt1+ (at or above)
HF - FixIdnetifier, TurnDirection, MagCourse, RouteTIMEDistanceHoldingTime
HM - FixIdentifier, TurnDirection, MagCourse, RouteTIMEDistanceHoldingTime
IF - FixIdentifier
PI - FixIdentifier, TurnDirection, RecommendedNavaid, Theta, RHO, MagCourse, RouteTimeDISTANCEHoldingTime (excursion distance from fix), Alt1
RF - FixIdentifier, TurnDirection, Theta (inbound tangential track), MagCourse, RouteTimeDISTANCEHoldingTime (along track distance), ArcCenter
TF - FixIdentifier, Overfly
VA - MagCourse (Heading), Alt1+ (at or above)
VD - RecommandedNavaid, MagCourse (Heading), RouteTimeDISTANCEHoldingTime (DME distance)
VI - MagCourse (Heading)
VM - MagCourse(Heading)
VR - RecommandedNavaid, Theta, MagCourse (Heading)
